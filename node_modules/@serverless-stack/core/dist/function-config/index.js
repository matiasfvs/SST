...
export async function listSecrets(app, stage, region) {
    ...
    async function page(prefix, token) {
...
export function buildSsmPrefixForSecret(app, stage) {
    return `/sst/${app}/${stage}/secrets/`;
}
export function buildSsmPrefixForSecretFallback(app) {
    return buildSsmPrefixForSecret(app, FALLBACK_STAGE);
}
export function buildSsmPrefixForParameter(app, stage) {
    return `/sst/${app}/${stage}/parameters/`;
}
export function buildSsmNameForSecret(app, stage, name) {
    return `${buildSsmPrefixForSecret(app, stage)}${name}`;
}
export function buildSsmNameForSecretFallback(app, name) {
    return buildSsmNameForSecret(app, FALLBACK_STAGE, name);
}
export function buildSsmNameForParameter(app, stage, name) {
    return `${buildSsmPrefixForParameter(app, stage)}${name}`;
}
function parseSsmName(ssmName) {
