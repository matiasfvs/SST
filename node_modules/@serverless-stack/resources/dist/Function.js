...
export class Function extends lambda.Function {
    constructor(scope, id, props) {
        ...
        const logRetention = props.logRetention && logs.RetentionDays[props.logRetention.toUpperCase()];
    ...
    addConfig(config) {
        ...
        (config || [])
            ...
            .forEach((c) => iamResources.push(`arn:aws:ssm:${app.region}:${app.account}:parameter${FunctionConfig.buildSsmNameForSecret(app.name, app.stage, c.name)}`, `arn:aws:ssm:${app.region}:${app.account}:parameter${FunctionConfig.buildSsmNameForSecretFallback(app.name, c.name)}`));
